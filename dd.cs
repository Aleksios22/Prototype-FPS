...
/* Script permettant de faire fonctionner l'arme à laqulle le script est attaché 
 * On modifie dans l'inspecteur les paramètres de l'arme
 * Créer par: Abdirahman Omar*/
public class fonctionnementRocket: MonoBehaviour
{
    ...
    public GameObject effetCollision; // Contient la reference de l'efet de collision
